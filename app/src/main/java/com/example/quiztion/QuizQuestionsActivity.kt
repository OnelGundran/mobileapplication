...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // START
        mUserName = intent.getStringExtra(Constents.USER_NAME)
        // END
                ...
                if (mSelectedOptionPosition == 0) {
                    ...
                    when {
                        ...
                        mCurrentPosition <= mQuestionsList!!.size -> {
                            ...
                            intent.putExtra(Constents.USER_NAME, mUserName)
                            intent.putExtra(Constents.CORRECT_ANSWERS, mCorrectAnswers)
                            intent.putExtra(Constents.TOTAL_QUESTIONS, mQuestionsList!!.size)
